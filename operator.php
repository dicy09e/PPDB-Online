...
<head>
    <title>Adminstrator - Operator</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="PPDB SMA N 11 Banda Aceh">
    <meta name="keywords" content="PPDB Online, PPDB SMA">
    <meta name="author" content="Fahrur Rizal">
    <!-- Favicon icon -->
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                    ...
                                    <div class="col-xl-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Peserta Check</h5>
                                                        <span class="text-muted">Sebelum data ini di <b>Konfirmasi</b>, pastikan anda sudah mengecek data-data nya dengan baik dan teliti, jika ada kesalahan anda bisa mengubah statusnya menjadi <b>Tidak Valid</b></span>
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar INNER JOIN data_asal_sekolah ON data_pendaftar.id_pendaftar = data_asal_sekolah.id_siswa INNER JOIN status_pendaftaran ON data_pendaftar.id_pendaftar = status_pendaftaran.id_siswa WHERE status = 'pengecekan' OR status = 'tidak_valid' OR status = 'konfirmasi' OR status = 'verifikasi'");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        	<a href="detail-operator/<?= $rowData['id_pendaftar'] ?>" class="btn btn-info btn-round btn-sm"><i class="feather icon-info"></i>Detail</a>  
                                                                            <?php if ($rowData['status'] === 'verifikasi'): ?>
                                                                                <button class="btn btn-success btn-round btn-sm"><i class="feather icon-check"></i> Verifikasi</button>
                                                                            <?php endif ?>
                                                                            <?php if ($rowData['status'] === "tidak_valid"): ?>
                                                                                <button class="btn btn-danger btn-round btn-sm"><i class="feather icon-info"></i> Tidak Valid</button>
                                                                            <?php endif ?>
                                                                            <?php if ($rowData['status'] === "konfirmasi"): ?>
                                                                                <button class="btn btn-info btn-round btn-sm"><i class="feather icon-check"></i> Konfirmasi</button>
                                                                            <?php endif ?>
                                                                            <?php if ($rowData['status'] === "pengecekan"): ?>
                                                                                <button class="btn btn-warning btn-round btn-sm"><i class="feather icon-info"></i> Pengecekan</button>
                                                                            <?php endif ?>
                                                                        </td>
                                                                    </tr>
                                                                    <?php $no++; ?>
                                ...
                                <div class="text-center">
                                    <p>Copyright &copy; 2022 by <a href="#">Fahrur Rizal</a></p>
                                </div>
