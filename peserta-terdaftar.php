...
<head>
    <title>Adminstrator - Peserta Terdaftar</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="PPDB SMA Negeri 11 Banda Aceh">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="col-xl-12 col-md-12">
                                        <a href="export-data/l/excel" class="btn btn-success btn-round btn-sm"><i class="feather icon-download"></i>download Excel</a>
                                        <a href="export-data/l/pdf" class="btn btn-primary btn-round btn-sm"><i class="feather icon-download"></i>download PDF</a>
                                        <br><br>
                                                <div class="card">
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar INNER JOIN data_asal_sekolah ON data_pendaftar.id_pendaftar = data_asal_sekolah.id_siswa INNER JOIN status_pendaftaran ON data_pendaftar.id_pendaftar = status_pendaftaran.id_siswa WHERE status = 'lolos'");
