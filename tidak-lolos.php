...
<head>
    <title>Adminstrator - Peserta Tidak Lolos</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="PPDB SMAN 11 Banda Aceh">
    <meta name="keywords" content="PPDB Online, PPDB SMAN 11">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="col-xl-12 col-md-12">
                                        <a href="export-data/tl/excel" class="btn btn-success btn-round btn-sm"><i class="feather icon-download"></i>download Excel</a>
                                        <a href="export-data/tl/pdf" class="btn btn-primary btn-round btn-sm"><i class="feather icon-download"></i>download PDF</a>
                                        <br><br>
                                                <div class="card">
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar INNER JOIN data_asal_sekolah ON data_pendaftar.id_pendaftar = data_asal_sekolah.id_siswa INNER JOIN status_pendaftaran ON data_pendaftar.id_pendaftar = status_pendaftaran.id_siswa WHERE status = 'tidak_lolos'");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        	<a href="detail-peserta/<?= $rowData['id_pendaftar'] ?>" class="btn btn-info btn-round btn-sm"><i class="feather icon-info"></i>Detail</a>  
                                ...
                                <div class="text-center">
                                    <p>Copyright &copy; 2022 by <a href="https://ft.serambimekkah.ac.id">Fahrur Rizal</a></p>
                                </div>
