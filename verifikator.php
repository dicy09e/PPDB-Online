...
<head>
    <title>Adminstrator - Verifikator</title>
    <meta charset="utf-8">
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                    ...
                                    <div class="col-xl-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Peserta Verifikasi</h5>
                                                        <span class="text-muted">Sebelum data ini di <b>Verifikasi</b>, pastikan anda sudah mengecek data-data nya dengan baik dan teliti, jika ada kesalahan anda bisa mengubah statusnya menjadi <b>Tidak Valid</b> Data akan tidak ada di table jika status nya sudah di terverifikasi</span>
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="tableAdmin" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                   	<?php 
                                                                   		$no = 1;
                                                                   		$queryDetail = mysqli_query($link, "SELECT * FROM data_pendaftar JOIN data_asal_sekolah ON data_pendaftar.id_pendaftar = data_asal_sekolah.id_siswa JOIN status_pendaftaran ON data_pendaftar.id_pendaftar = status_pendaftaran.id_siswa WHERE status = 'konfirmasi'");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        	<a href="detail-verifikator/<?= $rowData['id_pendaftar'] ?>" class="btn btn-info btn-round btn-sm"><i class="feather icon-info"></i>Detail</a>
                                                                        </td>
                                                                    </tr>
                                                                    <?php $no++; ?>
                                                                 <?php } ?>
                                ...
                                <div class="text-center">
                                    <p>Copyright &copy; 2020 by <a href="https://ft.serambimekkah.ac.id">Fahrur Rizal</a></p>
                                </div>
